...
(deftest check-helpers
  ...
  (testing
    "Create hash-map with one attribute"
  ...
  (testing
    "Create hash-map with multiple attribute"
    (is (= (conj testing-ctx {:payload {:type :hash, 
                                        :fields [:b :a], 
                                        :unique false},
                              }) 
  ...
  (testing
    "Create skiplist with one attribute"
  ...
  (testing
    "Create fulltext without minLength"
